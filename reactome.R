reactome <- function(genes_vec,workingdirectory,all_orthologs)
{
    pathway<-read.delim(paste(workingdirectory,"/Functional_Searches/reactome_orthologs.txt",sep=""))
    pathway<-pathway[-1,]
